    ...
    if ($lambat > 7) {
        ...
        ?>
            <script type="text/javascript">
                alert("Pinjam Buku Tidak Dapat diperpanjang, karena sudah lebih dari 7 hari..Kembalikan dahulu kemudian pinjam lagi");
        ...
        $sql = $koneksi->query("update transaksi set tgl_kembali='$hari_next' where id='$id'");
